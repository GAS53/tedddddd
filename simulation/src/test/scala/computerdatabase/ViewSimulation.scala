...
//  setUp(view.inject(atOnceUsers(1))).protocols(httpProtocol)
	setUp(view.inject(constantUsersPerSec(20).during(15)).protocols(httpProtocol).protocols(httpProtocol))
}